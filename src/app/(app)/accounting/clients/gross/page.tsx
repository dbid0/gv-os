...
/**
 * The GROSS client ledger (v2 §4): what each offer collected from its own
 * customers, derived from the transaction backlog. Attribution is computed at
 * read time; unmatched rows show as their own line, never dropped.
 *
 * This is NOT the agency book cut by client — that lives one level up, off the
 * finance-sheet mirror, and answers a different question: what GV earned. Two
 * sources, two meanings, kept on two pages so neither is mistaken for the
 * other. Nothing here changed when the book moved in above it.
 */
