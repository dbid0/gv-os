 ...
 * Windows reuse the dashboards' day bounds (rangeBounds) on the viewer's own
 * calendar, so "This month" means the same days wherever they look.
 *
...
/**
 * Whether a moment falls inside the window (the viewer's days, inclusive).
 ...
 */
export function inWindow(at: Date | null, b: RangeBounds, timeZone: string): boolean {
